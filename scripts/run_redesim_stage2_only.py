...
async def main() -> None:
    ...
    try:
        ...
        print("⏳ Processing all processes (this may take a few minutes)...\n")
            ...
            try:
                ...
                if row_index < total_processes - 1:
                    ...
                    try:
                        ...
                        print("   ↶ go_back() failed, navigating directly to results URL...")
                    ...
                    try:
                        ...
                        print("   ⚠️  Warning: Radio buttons not found, waiting longer...")
                        ...
                        try:
                            ...
                            print("   ❌ Error: Cannot find results list after navigation")
