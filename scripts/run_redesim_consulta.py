    ...
    try:
        ...
        if not gmail_creds_path.exists():
            ...
            if gmail_token_path.exists():
                ...
                print("ℹ️  Gmail token will be created during OAuth flow")
            ...
            try:
                ...
                if results_url_pattern not in page.url:
                    print("   ↶ Navigating to results URL...")
                ...
                print("   ✓ Iframe 'principal' resolved")
            ...
            print("   State file: /Volumes/MICRO/ATF/REDESIM/state.json")
            print("   Each process will update state.json after completion\n")
            ...
            for row_index in range(start_index, total_processes):
                ...
                try:
                    ...
                    if row_index < total_processes - 1:
                        print("   ↶ Returning to results list for next process...")
                        ...
                        try:
                            ...
                            print("   ✓ Iframe 'principal' re-resolved after navigation")
                            ...
                            if current_count > 0:
                                ...
                                print("   ⚠️  Warning: No radio buttons found in iframe after navigation")
                    ...
                    try:
                        if row_index < total_processes - 1:
                            print("   ↶ Attempting to return to results list after error...")
                            try:
